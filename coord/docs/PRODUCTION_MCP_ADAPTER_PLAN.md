...
| P2 | COORD-153 | Governance lifecycle checks for approval, redaction, receipt, cleanup, and promotion blockers. |
| P3 | COORD-154 | Read-only live-case adapter reference implementation. |
| P4 | COORD-155 | AWS ECS / temporary access cleanup receipt adapter pattern. |
