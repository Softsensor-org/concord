...
Observed in a downstream multi-agent burn-in (≈22 backend tickets, many
concurrent Claude subagents):
...
dispatch. Avoids whole agent runs. (Downstream evidence: FRESHNESS-001 was already
