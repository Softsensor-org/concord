...
This contract covers **repo bootstrap**: making a codebase safe for local
development, CI, and governed feature delivery. It does not authorize heavy
server-side startup work, historical backfills, generated fact-table population,
or production data repair. Those are governed by
